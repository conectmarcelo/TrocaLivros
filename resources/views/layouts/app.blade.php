        ...
        <nav class="navbar navbar-expand-lg navbar-light bg-info shadow-sm">
            <div class="container">
                ...
                <div class="collapse navbar-collapse d-flex justify-content-center" id="navbarSupportedContent">
                    ...
                    <div class="col-8" >
                        <form class="form-inline my-6 my-lg-0" style="margin: auto;">
                            <input size="50" class="form-control mr-sm-2" type="search" placeholder="Pesquisa por livro, autor..." aria-label="Search">
                        ...
                        <ul class="navbar-nav">
                            ...
                            <li class="nav-item">
                                <a class="nav-link" href="{{route('exemplar.index')}}">Meus Livros</a>
                            </li>
                            @endauth -->
